...
class TestPennyTradingEngine(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_penny_stock_buy_trailing_stop(self):
        ...
        self.mock_table_account.select.return_value.limit.return_value.execute.return_value.data = [acc_data]
    ...
    async def test_penny_breakeven_trigger(self):
        ...
        acc_data = {"id": 1, "cash_available": 10000.0, "total_assets": 10000.0}
        self.mock_table_account.select.return_value.limit.return_value.execute.return_value.data = [acc_data]
        self.mock_table_positions.select.return_value.eq.return_value.execute.return_value.data = [pos_data]
    ...
    async def test_penny_scale_out_trigger_and_tight_ts(self):
        ...
        self.mock_table_positions.select.return_value.eq.return_value.execute.return_value.data = [pos_data_scaled]
