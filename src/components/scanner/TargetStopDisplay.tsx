...
export const TargetStopDisplay = ({ stock }: { stock: Stock }) => {
  ...
  return (
    <div className="flex flex-col gap-1 bg-blue-50/50 p-2.5 rounded-lg border border-blue-200/80 min-w-[120px]">
      <div className="flex items-center justify-between text-[11px] font-mono">
        <span className="text-blue-500 font-bold uppercase tracking-wider">🎯 Target</span>
        <span className="text-emerald-600 font-black">${targetPrice.toFixed(2)}</span>
      </div>
      <div className="flex items-center justify-between text-[11px] font-mono mt-1">
       <span className="text-blue-500 font-bold uppercase tracking-wider">🛡️ Stop</span>
