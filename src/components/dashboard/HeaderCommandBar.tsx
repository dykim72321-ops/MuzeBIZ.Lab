  ...
  return (
    <div className="flex flex-col gap-2 min-w-[240px]">
      ...
      >
        <span
          className={clsx(
            'flex-1 flex items-center justify-center gap-2 px-4 py-2.5 font-black text-xs font-sans transition-colors',
        ...
        <span className="flex-1 text-center bg-blue-50 hover:bg-blue-100 px-4 py-2.5 text-xs text-blue-950 font-bold border-l border-blue-200 font-sans transition-colors">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          title="퀀트 전략 파라미터 설정"
          className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 h-full bg-transparent hover:bg-blue-50 border border-blue-200 hover:border-blue-400 text-blue-950 hover:text-black rounded-md transition-all text-xs font-black uppercase tracking-wider cursor-pointer shadow-sm"
        >
